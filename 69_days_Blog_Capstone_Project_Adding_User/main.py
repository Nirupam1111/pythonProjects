...
def register():
    login_from=RegisterForm()
    if login_from.validate_on_submit():
        email = login_from.email.data
        password=login_from.password.data
        name=login_from.name.data
    ...
    return render_template("register.html", form=login_from)
